...
[
    ...
    {
        'role': 'model',
        'parts': ['想像一下，電腦就像一個超級聰明的機器人，它可以做很多事情，比如玩遊戲、看影片、寫故事等等！\n\n它裡面有一個叫做「處理器」的大腦，負責思考和計算。另外還有「記憶體」，像是一個超大的筆記本，記錄著你正在做的事情。\n\n電腦使用「程式」來指示它要做什麼。這些程式就像是一本本說明書，告訴電腦每個步驟要怎麼做。\n\n當你按下鍵盤或滑鼠，電腦就會接收你的指令，然後依照程式，在「螢幕」上顯示結果。\n\n簡單來說，電腦就是一個超級聰明的機器人，會根據你給它的指令，做很多事情！\n']
    },
 {'role': 'user', 'parts': ['接著進一步詳細解釋給大學生聽。']}
 ]
 ```
