...
3. 定義函數。
    ...
    class trade:
        ...
        # 預設起始預期
        def restoreReturn(startDate='20080101', self, symbol):
            dirname = "data"
            ...
            if not os.path.exists(dividend_filename):
                ...
                url = f"https://www.twse.com.tw/rwd/zh/exRight/TWT49U?startDate={startDate}&endDate={today}&response=json&_=1706148539236"
