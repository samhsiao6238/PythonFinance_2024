...
2. 這個腳本存在諸多邏輯錯誤，這裡不列舉，以下是添加側邊欄位，並添加一個刪除本次對話的按鈕。
    ...
    #     if st.button(button_text, on_click=lambda: st.session_state.update(show_history=not st.session_state["show_history"])):
    #         pass
    ...
    if st.session_state["show_history"]:
        ...
        # user_input = st.text_input("你：", value=last_user_input)
        # 添加一個 key
