...
4. 在 `.env` 文件中添加前一個步驟取得的 Sandbox 資訊。
    ...
    NEO4J_URI = "bolt+s://af8ad467d7ab9724defe329604383717.neo4jsandbox.com:7687"
...
6. `Connect URL` 使用預設，切換到 `Username / Password`，添入前一個頁籤複製的密碼，接著點擊連線 `Connect`。

    ![](images/img_58.png)

<br>

7. 若連線資訊正確，便會進入連線畫面，相關操作亦可在此進行。
