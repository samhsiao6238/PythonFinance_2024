...
4. 嘗試：修改 `requirements.txt` 導入的模式。
...
5. 需要先解除安裝然後重新安裝。
    ...
    _解除_
    ```bash
    pip uninstall langchain langchain_core langchain_community langchain_openai neo4j-driver streamlit langchainhub openai -y
    ```
