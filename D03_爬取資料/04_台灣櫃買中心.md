...
[網址](https://www.tpex.org.tw/web/stock/aftertrading/otc_quotes_no1430/stk_wn1430.php?l=zh-tw)
...
2. 指令：假設腳本名稱為 `app.py`。
    ...
    ```bash
    python app.py 2023-12-01 2023-12-05
    ```

<br>

3. 假如在 Jupyter Notebook 中運行。

    ```python
    if __name__ == "__main__":
        # 在 Jupyter Notebook 中直接賦值或使用 input() 函數提示用戶輸入
...
1. [參考網址](https://github.com/FinMind/FinMindBook/blob/master/DataEngineering/Chapter5/5.2/src/tpex_crawler.py
)。

<br>

2. 程式碼：_在 Jupyter 中執行。
